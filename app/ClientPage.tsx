            ...
            <div className="grid gap-12 md:grid-cols-2">
              ...
              <div>
                <form
                  ...
                  className="overflow-hidden rounded-xl border border-white/10 bg-white/5 p-8 backdrop-blur-sm"
                >
                  ...
                  <Button type="submit" className="mt-8 w-full bg-gradient-to-r from-gradientPurple to-gradientPink py-6 text-lg font-medium text-white hover:opacity-90">
